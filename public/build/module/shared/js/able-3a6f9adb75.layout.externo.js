    ...
    var t = this.attr("id"), a = {
        ...
        PcodedMenuInit: function () {
            ...
            "vertical" === e.themelayout && (satnt = e.defaultVerticalMenu.desktop, "expanded" !== satnt && "compact" !== satnt || (mt = e.MenuTrigger, "click" === mt && $("#mobile-collapse").click(function (e) {
                e.preventDefault();
                var t = $(this);
                rel = t.attr("rel"), el = $(".pcoded-navbar"), "collapsed" == $("#pcoded").attr("vertical-nav-type") ? ($(".main-menu").slimScroll({destroy: !0}), $(".main-menu").css("overflow", "visible")) : $(".main-menu").slimScroll({
                    setTop: "1px",
                    size: "3px",
                    wheelStep: 10,
                    alwaysVisible: !1,
            ...
            !function () {
                $(document).on("click", function (e) {
                    var a = $(e.target), o = $("#" + t).attr("pcoded-device-type"),
                        i = $("#" + t).attr("vertical-nav-type"), d = $("#" + t).attr("theme-layout"),
                        n = $("#" + t + " .pcoded-item li");
                ...
                $(document).on("click", function (e) {
                    var a = $(e.target), o = $("#" + t + " .pcoded-search");
                ...
                case"horizontal":
                    "hover" === e.SubMenuTrigger ? $("li.pcoded-hasmenu").on("mouseenter mouseleave", function (e) {
                        if ($(".pcoded-submenu", this).length) {
                            var t = $(".pcoded-submenu:first", this), a = t.offset(), o = a.left, i = t.width();
                            $(window).height();
            ...
            var a = e.FixedNavbarPosition, o = e.FixedHeaderPosition;
            ...
            var a = e.menutype, o = e.freamtype;
            void 0 != a && "" != a ? $("#" + t).attr("nav-type", a) : $("#" + t).attr("nav-type", "st1"), void 0 != o && "" != o ? $("#" + t).attr("fream-type", o) : $("#" + t).attr("fream-type", "")
            ...
            switch (e.SubMenuTrigger) {
                case"hover":
                    ...
                    var o = $(window), i = $(".pcoded-submenu > li"), d = o.width(), n = "";
            ...
            switch (e.MenuTrigger) {
                case"hover":
                    ...
                    var o = $(window), i = $(".pcoded-item > li"), d = o.width(), n = "";
                    a(d >= 992 ? "hover" : "click"), o.resize(function () {
                        var e = o.width();
                        d != e && (e >= 992 && "hover" != n ? a("hover") : e < 992 && "click" != n && a("click"), d = e)
                    });
            ...
            "vertical" === e.themelayout ? $("#mobile-collapse,.sidebar_toggle a, .pcoded-overlay-box,.menu-toggle a").on("click", function () {
                ...
                if ("desktop" == a) {
                    var o = e.onToggleVerticalMenu.desktop, i = e.defaultVerticalMenu.desktop,
                        d = $("#" + t).attr("vertical-nav-type");
                    if (d == i) $("#" + t).attr("vertical-nav-type", o); else {
                        if (d != o) return !1;
                        $("#" + t).attr("vertical-nav-type", i)
                    }
                } else if ("tablet" == a) {
                    var n = e.onToggleVerticalMenu.tablet, r = e.defaultVerticalMenu.tablet,
                        c = $("#" + t).attr("vertical-nav-type");
                    c == r ? $("#" + t).attr("vertical-nav-type", n) : d == o && $("#" + t).attr("vertical-nav-type", r)
                } else if ("phone" == a) {
                    var l = e.onToggleVerticalMenu.phone, s = e.defaultVerticalMenu.phone,
            ...
            function a() {
                var a = $(window)[0].innerWidth;
                if ("vertical" === e.themelayout) if (a >= 768 && a <= 992) {
...
//# sourceMappingURL=able.layout.externo.js.map
